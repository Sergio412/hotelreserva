 ...
 * @author Sergio
 */
public class frvista_habitacion extends javax.swing.JFrame {

    /**
     * Creates new form frvista_habitacion
     */
    public frvista_habitacion() {
        initComponents();
        mostrar("");
...
void mostrar(String buscar) {
    ...
    private void tablalistadoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistadoMousePressed
        ...
        if (evt.getClickCount() == 2) {
            ...
            frreserva.txtidhabitacion.setText(cod);
            frreserva.txtnumero.setText(valor);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frvista_habitacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frvista_habitacion().setVisible(true);
            }
        });
    }
