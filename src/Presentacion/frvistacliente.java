 ...
 * @author Sergio
 */
public class frvistacliente extends javax.swing.JFrame {

    /**
     * Creates new form frvistacliente
     */
    public frvistacliente() {
        initComponents();
        mostrar("");
    ...
    private void tablalistado2MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistado2MousePressed
        ...
        if (evt.getClickCount() == 2) {
            ...
            valor=tablalistado2.getValueAt(fila, 1).toString()+" "+tablalistado2.getValueAt(fila, 2).toString();
            
            frreserva.txtidcliente.setText(cod);
            frreserva.txtcliente.setText(valor);
            this.dispose();
        }   
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frvistacliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frvistacliente().setVisible(true);
            }
        });
    }
